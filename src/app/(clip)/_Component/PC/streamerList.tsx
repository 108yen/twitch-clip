    ...
    return (
        ...
        >
            ...
            >
                ...
                <NoDecorationTypography variant='subtitle1' noWrap>
                    <Skeleton width={150} />
...
function StreamerListItem({ streamer }: { streamer: Streamer }) {
    return (
        <Box
            sx={{
                paddingY: 1
...
function StreamerList() {
    ...
    if (
        ...
        return (
            <Box mt={6} mb={3} ml={3} mr={0} width={200} overflow='hidden'>
                <Stack
                    direction='row'
                ...
                <Divider />
                {streamersValue.data.slice(0, 10).map((e, index) => (
        ...
        return (
            <Box mt={6} mb={3} ml={3} mr={0} overflow='hidden'>
                <Typography variant='subtitle1' color='grey'>
                    channels
                </Typography>
                <Divider />
